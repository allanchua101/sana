import{_ as s,o as i,c as a,R as n}from"./chunks/framework.KK7BHIzh.js";const r=JSON.parse('{"title":"sana lambda-logging-kpis","description":"","frontmatter":{},"headers":[],"relativePath":"lambda/concepts/logging-kpis.md","filePath":"lambda/concepts/logging-kpis.md"}'),l={name:"lambda/concepts/logging-kpis.md"},p=n(`<h1 id="sana-lambda-logging-kpis" tabindex="-1"><code>sana lambda-logging-kpis</code> <a class="header-anchor" href="#sana-lambda-logging-kpis" aria-label="Permalink to &quot;\`sana lambda-logging-kpis\`&quot;">​</a></h1><p>Use this command to get a quick overview of logging-related metrics in your target account/region:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">$</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> sana</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> lambda-logging-kpis</span></span>
