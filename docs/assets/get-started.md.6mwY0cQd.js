...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">&gt; --------------------------------------------</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">&gt; Done!</span></span></code></pre></div><h3 id="next-steps" tabindex="-1">Next Steps <a class="header-anchor" href="#next-steps" aria-label="Permalink to &quot;Next Steps&quot;">​</a></h3><p>Learn more about the most common flags that could be used to modify the default behaviors of sana.</p>`,11),e=[l];function p(h,k,r,g,c,d){return a(),i("div",null,e)}const y=s(t,[["render",p]]);export{F as __pageData,y as default};
